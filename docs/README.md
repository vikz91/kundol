...
For implemented behavior, start with [usage](usage.md), [public commands](commands.md), and [codebase context](context.md). Try project cleanup against disposable files with the [Docker sandbox](demo/docker-sandbox.md). Research pages distinguish published rules from future work.
...
| System and project knowledge | [Storage optimiser](storage-optimizer.md), [storage/config](storage-config.md), [Docker](docker.md), [project runtimes](project-runtimes.md), [dependencies](dependencies.md). |
