...
The Docker seed script reuses this workspace generator under `/sandbox` inside the container. It does not provide a Docker daemon or macOS startup simulation.
