...
| KUN-004 | Foundation | Create initial Bun CLI entrypoint with help output and command routing. | don | Fullstack Developer Agent 1 | 2026-06-13 07:18:52 IST | 2026-06-15 15:20:29 IST | 2026-06-15 15:23:03 IST | KUN-003 | Added Commander entrypoint and MVP command skeletons for `init`, `index`, `dashboard`, `list`, `show`, `scan`, `clean`, `runtimes`, and `config`; handlers delegate to placeholder action functions. |
